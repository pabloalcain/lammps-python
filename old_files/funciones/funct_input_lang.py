...
def get_coulomb(val):
    ...
    if (cou<0 or cou > 10):
	raise ValueError ("Sólo soportados enteros entre 0 y 10 para lambda")
    return cou
...
def write_input(pot,cou,fname,x,N,rho,Ti):
    ...
    str="# Nuclear model\n\n"+\
        ...
        "kspace_style\tnone\n\n"+\
        "neighbor\t0.3 bin\n"+\
        "neigh_modify\tevery 40 delay 0 check yes one 8000 page 80000\n\n"+\
	"fix\t\t1 all nve\n\n"+\
